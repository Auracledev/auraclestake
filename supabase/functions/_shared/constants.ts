...
export const VAULT_WALLET = VAULT_ADDRESS;

// Security constants
export const MAX_STAKE_AMOUNT = 10000000; // 10M AURACLE
export const MAX_UNSTAKE_AMOUNT = 10000000; // 10M AURACLE
export const SIGNATURE_EXPIRY_MS = 5 * 60 * 1000; // 5 minutes
export const HELIUS_WEBHOOK_ID = '9ca4a83e-c2b8-4484-9cf5-c7877d319151';